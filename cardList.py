...
card.append([1, 1, 6, "Frost", "common", scale1, "description", "cardTemp.png", {"type": "minion", "skill": "freeze", "n": 1}])
...
card.append([2, 2, 3, "Ice", "common", scale1, "description", "cardTemp.png", {"type": "minion", "skill": "freeze", "n": 1}])
...
card.append([2, 3, 7, "Medic", "rare", scale1, "description", "cardTemp.png", {"type": "minion", "skill": "cure", "n": 3}])
...
card.append([5, 5, 10, "ElderSage", "epic", scale1, "description", "cardTemp.png", {"type": "minion", "skill": "draw", "n": 2}])
...
card.append([5, 5, 10, "Wizard", "legendary", scale1, "description", "cardTemp.png", {"type": "minion", "skill": "draw", "n": 2}])
