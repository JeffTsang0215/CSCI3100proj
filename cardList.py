...
# COMMON CARDS
card.append([0, 1, 3, "Goblin", "common", scale1, "description", "Bob the undying.png", {"type": "minion"}]) #0
...
# RARE CARDS
card.append([2, 5, 3, "Assassin", "rare", scale1, "description", "cardTemp.png", {"type": "minion"}]) #8
...
# EPIC CARDS
card.append([3, 4, 7, "Vampire", "epic", scale1, "description", "cardTemp.png", {"type": "minion"}]) #16
...
# LEGENDARY CARDS
card.append([4, 5, 8, "Infernal", "legendary", scale1, "description", "cardTemp.png", {"type": "minion"}]) #24
